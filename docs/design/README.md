...
| [07 — Multiple Plan 9 VMs](07-multiple-plan9-vms.md) | Explicit management forwards implemented and qualified; shared Ethernet and lab orchestration remain future work | You are considering concurrent guests, networking isolation, or port allocation. |
